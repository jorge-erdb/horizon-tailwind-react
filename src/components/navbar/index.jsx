...
const Navbar = (props) => {
  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0F172A4d]">
      {/* The template had a "Pages / <section>" breadcrumb above this, but
          both of its links pointed at " " and "#". Nova's dashboard is two
          levels deep and the sidebar already marks the active section, so
          the trail was decoration over dead links. The heading stays. */}
      <div className="ml-[6px]">
        <h1 className="shrink text-[33px] font-bold capitalize text-navy-700 dark:text-white">
          {brandText}
        </h1>
      </div>

      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        {/* A search input sat here with no value, no onChange and no
            handler — typing in it did nothing. Removed rather than left as
            bait; see FUTURE_PLANS.md, which treats real search across
            sources, reports, alerts and tasks as a feature to design. */}
        <span
